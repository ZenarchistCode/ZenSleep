// TODO: ADD DAY / NIGHT TIME OVERRIDE?
class ZenSleepConfig
{
	...
	bool SleepBlackScreen = true; // Enable/disable screen going black when lying down
	...
	ref array<ref EnergyDrink> EnergyDrinks = new array<ref EnergyDrink>; // List of energy drink objects
	...
	// Debug config
	bool DebugOn = false; // Enable/disable debug mode
